...
<View style={{ marginTop: 20, width: Dimensions.get('screen').width * 0.764 }}>
  <Hearts heartsContainers={this.state.heartsContainers} hearts={this.state.hearts} align={'center'} />
</View>
...
export default class Hearts extends Component {
  ...
  render() {
    return (
      <Animated.View style={{ alignSelf: this.align }}>
