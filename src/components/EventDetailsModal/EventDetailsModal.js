        ...
        return (
            <Modal
                ...
                <View style={styles.mainContainer}>
                    <ScrollView contentContainerStyle={styles.eventInfoContainer}>
                        <QaplaIcon
                        ...
                        <View style={styles.container}>
                            ...
                            <TouchableOpacity style={styles.participateButtonContainer}>
...
export default connect(mapDispatchToProps)(EventDetailsModal);
