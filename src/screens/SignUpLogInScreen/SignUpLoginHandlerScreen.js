            ...
            <View
                ...
                {this.state.actualScreen.includes('twitch') ?
                    ...
                    this.state.actualScreen === 'signUpLogInComplete' ?
                        ...
                        <View style={{ flex: 1, alignItems: 'center', marginTop: heightPercentageToPx(10) }}>
                                    ...
                                    <Animated.View style={{
                                        transform: [{
                                            translateY: this.state.succesfulRegisterTitleYPositionController.interpolate({
                                                inputRange: [0, 1],
                                                outputRange: [heightPercentageToPx(4), 0],
                                            }),
                                        }],
                                    }}>
                            ...
                            <Animated.View style={{
                                ...
                                transform: [{
                                    translateY: this.state.succesfulRegisterButtonYPositionController.interpolate({
                                        inputRange: [0, 1],
                                        outputRange: [heightPercentageToPx(9.5), 0],
                                    }),
                                }],
                            }}>
                                <View>
                                    <TouchableOpacity
                                        ...
                                        <Text style={[styles.succesfulLoginButtonText, styles.darkQaplaTextColor]}>Volver a los streams</Text>
                                    </TouchableOpacity>
                                </View>
                            </Animated.View>
                        </View>
                        ...
                        <View style={{ flex: 1, height: '100%', width: '100%', alignItems: 'center', marginTop: this.state.keyboardIsActive ? '9.8%' : 0 }}>
                            ...
                            <View style={{ alignItems: 'center' }}>
                                                    ...
                                                    transform: [
                                                        {
                                                            translateX: this.state.titleXPositionController.interpolate({
                                                                inputRange: [-1, 0, 1],
                                                                outputRange: [widthPercentageToPx(70), 0, -widthPercentageToPx(70)],
                                                            }),
                                                        },
                                                    ],
                                                }}>
                                ...
                                <View style={{
                                    width: widthPercentageToPx(70),
                                    overflow: 'hidden',
                                    marginTop: this.state.actualScreen !== 'logIn' ? heightPercentageToPx(10) : 0
                                }}>
                                    {(this.state.actualScreen === 'init' || (Platform.OS === 'ios' && appleAuth.isSignUpButtonSupported)) &&
                                        <Animated.View style={{
                                            width: '100%',
            ...
            <>
                ...
                <SafeAreaView style={styles.sfvContainer}>
                    <AnimatedTouchableOpacity
                        ...
                        style={{
                            width: this.state.closeBackButtonIconWidth.interpolate({ inputRange: [40, 88], outputRange: [48, widthPercentageToPx(23.46)] }),
                            height: 48,
                            marginTop: 16,
                            marginLeft: this.state.closeBackButtonIconMarginLeft.interpolate({ inputRange: [0, 1], outputRange: [16, widthPercentageToPx(70)] }),
                            justifyContent: 'center',
                            overflow: 'hidden',
                    ...
                    {(this.state.actualScreen === 'init' || this.state.actualScreen === 'logIn' || this.state.actualScreen == 'signUp') &&
                        ...
                        style={
                            [styles.registroInicioSesionView,
                            {
                                marginTop: this.state.linearGradientContrainerYPositionController.interpolate({
                                    inputRange: [0, 1],
                                    outputRange: [heightPercentageToPx(6.26), 16],
                                }),
                            }]} >
                        <Animated.View
                            style={{
